            ...
            <div className="flex flex-col md:flex-row items-center mb-12">
                <div className="flex-1">
                    ...
                    <div className="mb-4 mt-8">
                        ...
                        <a href="mailto:youremail@gmail.com" className='hover:underline'>
                            congvo.heaven@gmail.com
                        </a>
                    </div>
                    <div className="mb-4 mt-8">
                        <FaPhone className="inline-block text-green-400 mr-2"></FaPhone>
                        <span>0973580341</span>
                    </div>
                    <div className="mb-4 mt-8">
                        <FaMapMarked className='inline-block text-green-400 mr-2'></FaMapMarked>
